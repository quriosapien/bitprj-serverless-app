...
## ✅  Tasks:
- [ ] Read and explore the documentation for the [Cataas API](https://cataas.com/#/)
- [ ] With Postman, specify the API Endpoint and set the parameters to send a GET request to the [CataaS API](https://cataas.com/#/) and receive a cat picture with "Serverless" written on it
